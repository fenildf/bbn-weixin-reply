...
set :deploy_to, '/web/bbn-weixin-reply'
set :current_path, 'current'
set :repository, 'https://github.com/mindpin/bbn-weixin-reply.git'
set :branch, 'master'
set :user, 'root'
set :term_mode, nil
...
task :setup => :environment do
  ...
  nginx = MinaUtil::Builder.ask_nginx('bbn-weixin-reply', '/web/bbn-weixin-reply')
  queue! %[echo '#{nginx}' > "/etc/nginx/conf.d/bbn-weixin-reply.conf"]
  #test
  #queue! %[echo '#{nginx}' > "/home/dd/bbn-weixin-reply.conf"]
